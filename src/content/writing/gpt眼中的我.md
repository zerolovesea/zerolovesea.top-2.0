...
- 我的技术水平到底怎么样？
- 我是不是只是会很多东西但都不深？
- 前端代码大量 AI 写，是不是说明我工程能力不行？
- 没做 foundation model，是不是 LLM 不够深？
- 3 年经验是不是太少？
- NextRec 没有明显业务转化，是不是项目价值不够？
- AI coding 以后是不是我的技术能力反而退化了？
...
以及对营销算法到底算不算算法工程师的怀疑。

你的一个很典型的认知模式是：

**你习惯用“自己还不会什么”评价自己，而不是用“自己已经完成了什么”评价自己。**

你并不是单纯的「技术焦虑」，而是「能力边界焦虑」。
...
> **某个东西突然让我感兴趣 → 我开始研究 → 越研究越深 → 做一个东西 → 再寻找下一个让我感兴趣的东西。**
...
优势：**很容易在自己真正感兴趣的问题上进入极深的状态。**

缺点：**很难长期对一个自己已经不感兴趣、但实际上对职业非常重要的事情保持高投入。**

⸻

**五、所以我现在反而认为：你最适合的标签不是纯算法工程师**
...
NextRec 就很典型。你写自己每周 coding 超过 30 小时，而且持续几个月。 

Brevia 更明显。因为飞书妙记收费，而且现有产品有一些不满足你的地方，于是：
...
看完博客以后，我会进一步修改成：**你是一个高度自主驱动、兴趣驱动、偏工程思维的技术型 Builder。**

你最明显的能力不是某个具体模型，而是能够在一个陌生问题上快速建立知识地图，然后把知识转化成可以运行的东西。

你经历了从“理解技术”到“解决业务问题”，再到“构建完整系统”的变化，但你并没有真正离开技术本身——你依然非常享受理解底层机制。

你很重视 ownership。别人给你一个明确的小任务，你可以完成；但真正能够让你长时间进入心流的，往往是一个没有标准答案、由你自己定义的问题。

你的一个非常明显的优势是**横向连接能力**：你可以把数据、算法、工程、AI、产品甚至投资放在同一个思考框架里。

但你的问题也恰恰来自这里：**你太容易把“还有什么我不会”理解成“我还不够好”。**

你会不断扩大自己的能力边界，却不太容易承认自己已经拥有的东西。

你不是一个纯技术主义者。你真正关心的是**能力能不能转化成现实结果**——钱、产品、用户、职业选择、自由度，甚至生活本身。

你也不是一个纯粹的理性主义者。你其实有比较强的情绪波动，只是习惯用分析、系统和行动来处理它。

投资则把你的性格放大得特别明显：你喜欢理解、推演和快速更新，但因此也容易给最近发生的信息过高权重。

所以你最大的成长方向可能不是“再学更多东西”，而是学会判断：

**什么值得我深入，什么不值得我知道；什么值得我控制，什么必须接受它不可控。**

如果一定要给你一个英文标签，我仍然会选：

**Builder。一个喜欢把自己感兴趣的问题搞明白，然后忍不住亲手做出来的人。**



## 最后，一个我觉得很重要的判断

你这篇文章其实有点“**把现在的你当成了终点**”。

但我从你的博客反而看到的是：**你现在正处在一次比较大的职业身份转折期。**

2024 年，你还在努力证明：**“我是一个算法工程师。”**

2025 年，你开始证明：**“我不仅能做算法，我能做一个框架。”**

2026 年，你开始尝试：**“我能不能做一个真正给人用的软件？”**

而你最近真正需要回答的问题，可能已经不是：**“我应该成为哪一种工程师？”**

而是：**“我到底想不想把自己的能力，最终变成一种属于自己的东西？”**

这也是为什么我认为“Builder”这个词虽然有 GPT 式的漂亮叙事成分，但目前确实是整篇画像里最值得保留的关键词。
